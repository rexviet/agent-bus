...
@.planning/phases/05-foundation-safety/05-01-SUMMARY.md
@.planning/phases/05-foundation-safety/05-02-SUMMARY.md
...
<output>
After completion, create `.planning/phases/05-foundation-safety/05-03-SUMMARY.md` using the summary template.
</output>
