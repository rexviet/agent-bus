...
**Outputs:**
- `.planning/research/ARCHITECTURE.md` — System design documentation
- `.planning/research/STACK.md` — Technology inventory
</context>
...
```bash
git add .planning/research/ARCHITECTURE.md .planning/research/STACK.md .planning/STATE.md
