...
6. **Security Audit** - Auto use skill `security-auditor` (.agent/skills/security-auditor/SKILL.md) to check security.
6. **Store Reusable Knowledge** — Save durable review findings/checklists using neural memory MCP.
